...
namespace CANBOOKRAM_V01.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var userProfileDetail = new ProfileDetail();
                    ...
                    userProfileDetail.Hidden = 0;
                    userProfileDetail.Email = Input.Email;
                    await _context.ProfileDetails.AddAsync(userProfileDetail);
